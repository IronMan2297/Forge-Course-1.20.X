package net.ironman.mccourse.datagen.loot;

import net.ironman.mccourse.block.ModBlocks;
import net.ironman.mccourse.block.custom.CattailCropBlock;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
       ...
       // this.dropSelf(ModBlocks.KAUPEN_PORTAL.get());
        ...
        //This if Only top Block drop something
